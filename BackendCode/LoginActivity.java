...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMobile = (EditText) findViewById(R.id.login_email);
    ...
    private class LoginAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                URL url = new URL(apis.getUserLogin());
                ...
                strJsonBody = "{"
                        + "\"email\": \"" + mMobile.getEditableText().toString()+ "\","
               ...
               // JSONObject jsonObjectdetails = jsonObjectresult.getJSONObject("details");
                libuser_id =  jsonObjectresult.getString("_id");
